:project-name: miq-RedHat-Satellite5
:project-repo: https://github.com/rhtconsulting/miq-RedHat-Satellite5
:project-zip: https://github.com/rhtconsulting/miq-RedHat-Satellite5/archive/master.zip
